...
-- SEATBELT PARAMETERS
local seatbeltInput = 29                   -- Toggle seatbelt on/off with K
...
local cruiseInput = 83                     -- Toggle cruise on/off with CAPSLOCK or A button (controller)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        if (IsPedInAnyVehicle(player, false)) then
            ...
            drawTxt(("%.3d"):format(math.ceil(speed)), 2, speedColor, 0.8, screenPosX + 0.06, screenPosY + 0.0165)
            ...
            drawTxt(timeText, 4, {255,255,255}, 0.4, screenPosX + 0.001, screenPosY + 0.0450)

            -- Draw cruise control status
            cruiseColor = cruiseIsOn and cruiseColorOn or cruiseColorOff
            --drawTxt("CRUISE", 2, cruiseColor, 0.4, screenPosX + 0.001, screenPosY + 0.048)

            -- Draw seatbelt status
            seatbeltColor = seatbeltIsOn and seatbeltColorOn or seatbeltColorOff
            drawTxt("BELT", 2, seatbeltColor, 0.4, screenPosX + 0.04, screenPosY + 0.0450)
            ...
            drawTxt(locationText, 4, locationColorText, 0.4, screenPosX + 0.001, screenPosY + 0.074)
        else
