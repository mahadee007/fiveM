...
Citizen.CreateThread(function()
    while true do 
        ...
        if Vehicle.Vehicle ~= nil then
            ...
            if IsControlPressed(0, Keys["LEFTSHIFT"]) and IsVehicleSeatFree(Vehicle.Vehicle, -1) and not IsEntityAttachedToEntity(ped, Vehicle.Vehicle) and IsControlJustPressed(0, Keys["E"]) and IsPedWalking(playerPed) and GetVehicleEngineHealth(Vehicle.Vehicle) <= Config.DamageNeeded then
