		...
		while true do
			...
			if displayHud then
				if tonumber(fuel) < 30 then
					...
					DrawAdvancedText(0.305 - x, 0.90 - y, 0.015, 0.0028, 0.6, fuel, 255, 255, 255, 255, 6, 1)
				end
		
				DrawAdvancedText(0.262 - x, 0.90 - y, 0.015, 0.0028, 0.6, kmh, 100, 181, 246, 255, 6, 1)
				
				--DrawAdvancedText(0.148 - x, 0.7765 - y, 0.005, 0.0028, 0.4, "mp/h              km/h              Fuel", 255, 255, 255, 255, 6, 1)
				DrawAdvancedText(0.282 - x, 0.90 - y, 0.015, 0.0028, 0.4, "km/h              Fuel", 255, 255, 255, 255, 6, 1)
			else
				Citizen.Wait(750)
			end
		end
