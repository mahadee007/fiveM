...
function createNoClipMenuOptions()
    local options = {"Noclip Toggle: F9","W = เดินหน้า","S = ถอยหลัง","A = เลี้ยวซ้าย","D = เลี้ยวขวา","Q = ลอยขึ้น","Z = ลงล่าง","Shift = ความเร็ว"}
    local speeds = { "ช้ามาก", "ช้าปานกลาง", "ช้า", "ปกติ", "เร็ว", "เร็วมาก", "เร็วเหี้ยๆ" }
    local menuOpts = {}
