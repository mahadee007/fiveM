...
RegisterNetEvent("esx_inventorywanpen:openTrunkInventory")
AddEventHandler(
    "esx_inventorywanpen:openTrunkInventory",
...
RegisterNetEvent("esx_inventorywanpen:refreshTrunkInventory")
AddEventHandler(
    "esx_inventorywanpen:refreshTrunkInventory",
    function(data, blackMoney, inventory, weapons)
        setTrunkInventoryData(data, blackMoney, inventory, weapons)
    end
)
