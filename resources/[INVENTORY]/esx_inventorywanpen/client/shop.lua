...
function OpenShopInv(shoptype)
    ...
    Citizen.Wait(500)
    TriggerEvent("esx_inventorywanpen:openShopInventory", data, inventory)
end
...
RegisterNetEvent("esx_inventorywanpen:openShopInventory")
AddEventHandler("esx_inventorywanpen:openShopInventory", function(data, inventory)
