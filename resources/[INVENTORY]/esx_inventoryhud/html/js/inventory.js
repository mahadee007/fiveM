...
window.addEventListener("message", function (event) {
    if (event.data.action == "display") {
		...
		$('.secContent').fadeOut(200, function(){
			$("#controls").css("flex", "0.15");
			$('.inventory-grid').css("grid-template-columns", "1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr 1fr");
		});
		...
		$(".header-text-right").html("SECOND INVENTORY");
...
function secondInventorySetup(items) {
	$('.inventory-grid').css("grid-template-columns", "1fr 1fr 1fr 1fr 1fr 1fr");
	
	$("#controls").css("flex", "0.2");
	...
	$("#second-inventory").fadeIn(200, function(){
		$('#otherInventory').css("flex", "1");
		$('.inventory-grid').css("grid-template-columns", "1fr 1fr 1fr 1fr 1fr 1fr");
		$('.secContent').fadeIn(500);
		$('.controls-logo').css("width", "90%");
	});
}
