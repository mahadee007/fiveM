...
Config.CloseUiItems = {"water","bread","suit2","suit1","soda","radio","phone","anesthetic1", "anesthetic2", "bandage", "basket_orange", "defibrillator", "driver_license", "fixtool","id_card","medikit","mushroom_shovel","rock_excavator","scissors_rice","wood_cutting_ax"}

-- Limit, unit can be whatever you want. Originally grams (as average people can hold 25kg)
Config.Limit = 45000
Config.WeightCheckRate = 2 -- เช็คว่าน้ำหนักเกินไหมทุกกี่วิ
...
Config.disableGive = {
	...
	id_card = false,
	medikit = false,
	mushroom_shovel = true,
	rock_excavator = true,
	scissors_rice = true,
	wood_cutting_ax = true,
	cement = true,
	suit1 = false,
	suit2 = false,
}
