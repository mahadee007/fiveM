...
Citizen.CreateThread(function()
    while true do
        ...
        if IsInRegularShopZone(coords) or IsInRobsLiquorZone(coords) or IsInYouToolZone(coords) or IsInPrisonShopZone(coords) then
            ESX.ShowHelpNotification("Press ~r~E~w~ Open to shop ")
