				...
				t.fn.iqDropdown = function (e) {
					...
					function r(n, e, o) {
						var r = t("<div />").addClass(u.controls.controlsCls),
							i = t("<button class='btn btn-default btn-xs w1msleft' style='margin-left: -5px;'>" + u.controls.decrementText + "</button> "),
							s = t("<button class='btn btn-default btn-xs w1msright' style='margin-right: -5px;'>" + u.controls.incrementText + "</button>"),
							a = t("<span class='countmm'>" + l[n] + "</span>").addClass(u.controls.counterCls);
