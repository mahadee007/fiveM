...
local AnimalPositions = {
	{ x = -1009.98, y = 4230.04, z = 110.16 },
	{ x = -1009.15, y = 4247.36, z = 107.53 },
	{ x = -997.23, y = 4242.01, z = 107.54 },
	{ x = -1001.59, y = 4229.57, z = 108.24 },
}

local AnimalsInSession = {}

local Positions = {
	['StartHunting'] = { ['hint'] = '[E] Start Hunting', ['x'] = -1029.62, ['y'] = 4224.05, ['z'] = 117.32 },
	['Sell'] = { ['hint'] = '[E] Sell', ['x'] = -976.51, ['y'] = -1433.2, ['z'] = 7.68 },
	['SpawnATV'] = { ['x'] = -7649.63067626953, ['y'] = 55942.7573242188, ['z'] = 343.48571395874 }
}
...
function SlaughterAnimal(AnimalId)
	...
	ESX.ShowNotification('You slaughtered the animal and recieved an deer of ' ..AnimalWeight.. 'kg')

	TriggerServerEvent('esx-killdeer:reward', AnimalWeight)

	DeleteEntity(AnimalId)
end

function SellItems()
	TriggerServerEvent('esx-killdeer:sell')
end
