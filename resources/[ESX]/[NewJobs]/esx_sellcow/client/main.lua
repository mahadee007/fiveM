...
--[[Citizen.CreateThread(function()
    ...
    local blip = AddBlipForCoord(471.17,2608.18,44.48)
    ...
    AddTextComponentString('Cow Sell')
...
local Positions = {
	--['StartHunting'] = { ['hint'] = '[E] Start working', ['x'] = 2385.1276855469, ['y'] = 5032.7734375, ['z'] = 45.946147918701 },
	['Sell'] = { ['hint'] = '[E] Sell Cow Package', ['x'] = 552.403747558, ['y'] = 2663.556396, ['z'] = 45.5735389 }
    --['Porkpack'] = { ['hint'] = '[E] Pork pack', ['x'] = 998.09234619141, ['y'] = -2143.8308105469, ['z'] = 29.52868270874 }
				...
				for index, value in ipairs(AnimalsInSession) do
					if DoesEntityExist(value.id) then
						...
						if PlyToAnimal < 2.0 then
							...
							ESX.Game.Utils.DrawText3D({x = AnimalCoords.x, y = AnimalCoords.y, z = AnimalCoords.z + 1}, '[E] Get pork', 0.4)
...
--[[function SlaughterAnimal(AnimalId)
	...
	ESX.ShowNotification('You slaughtered the pig and received an pork.')
...
function SellItems()
	TriggerServerEvent('esx_sellcow:sell')
end
...
--[[function Porkpack()
	...
	TriggerEvent("pNotify:SendNotification", {text = "กรุณารอ 20 วินาที!", type = "success", timeout = 20000, layout = "centerLeft"})
	Citizen.Wait(20000)
