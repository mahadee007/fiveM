...
function OpenCabbage()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cabbage_shop', {
		title    = 'Cabbages ',
		align    = 'top-left',
		elements = elements
	}, function(data, menu)
		TriggerServerEvent('esx_SellCabbage:sell', data.current.name, data.current.value)
