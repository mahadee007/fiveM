...
function SlaughterAnimal(AnimalId)
	...
	Isworking = true
	exports['progressBars']:startUI(7000, "กำลังเก็บเนื้อหมู....")
	Citizen.Wait(7000)
...
function Porkpack()
	...
	TriggerEvent("pNotify:SendNotification", {text = "กรุณารอ 10 วินาที!", type = "success", timeout = 10000, layout = "centerLeft"})
	Citizen.Wait(10000)
