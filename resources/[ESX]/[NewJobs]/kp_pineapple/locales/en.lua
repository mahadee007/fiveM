Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~y~PineApple~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~y~PineApple~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process PineApple~s~.',
  ['weed_processingstarted'] = 'processing ~g~PineApple~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~PineApple~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'PineApple Field',
  ['blip_weedprocessing'] = 'PineApple Processing',
