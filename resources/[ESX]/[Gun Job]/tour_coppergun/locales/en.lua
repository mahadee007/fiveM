Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~r~copper_gun~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~r~copper_gun~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process copper_gun~s~.',
  ['weed_processingstarted'] = 'processing ~g~copper_gun~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~copper_gun~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'copper_gun Field',
  ['blip_weedprocessing'] = 'copper_gun Processing',
