Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to harvest the ~r~irongun~s~.',
  ['weed_inventoryfull'] = 'you do not have any more inventory space for ~r~irongun~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process irongun~s~.',
  ['weed_processingstarted'] = 'processing ~g~irongun~s~ into ~g~Transparent Glass ~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~irongun~s~ in order to process.',
  ...
  -- blips
  ['blip_weedfield'] = 'irongun Field',
  ['blip_weedprocessing'] = 'irongun Processing',
