	...
	while true do
		...
		if nearbyObject and IsPedOnFoot(playerPed) then
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('tour_iron:canPickUp', function(canPickUp)
					...
					if canPickUp then
						...
						TriggerServerEvent('tour_iron:pickedUpCannabis')
					else
...
function SpawnPinees()
	while spawnedPines < 20 do
		...
		ESX.Game.SpawnLocalObject('prop_rub_carwreck_10', pineCoords, function(obj)
