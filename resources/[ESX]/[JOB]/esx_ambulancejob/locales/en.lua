Locales['en'] = {
  ...
  ['medikit'] = 'ชุดช่วยชีวิต',
  ['bandage'] = 'ชุดรักษาแผล',
  ['repairkit'] = 'เครื่องมือซ่อมรถ',
  ['oxygenmask'] = 'หน้ากากดำน้ำ',  
  ...
  -- Death
  ['respawn_available_in'] = 'จะฟื้นคืนชีพใน ~b~%s นาที %s วินาที~s~',
  ['respawn_bleedout_in'] = 'คุณจะตายใน ~b~%s นาที %s วินาที~s~\n',
  ['respawn_bleedout_prompt'] = 'กดปุ่ม [~b~E~s~] to respawn',
  ['respawn_bleedout_fine'] = 'กดปุ่ม [~b~E~s~] to เพื่อฟื้น ~g~$%s~s~',
  ['respawn_bleedout_fine_msg'] = 'คุณจ่าย ~r~$%s~s~ สำหรับการฟื้นคืนชีพ.',
  ['distress_send'] = 'กด [~b~G~s~] เรียกแพทย์',
  ...
  ['healed'] = 'you have been treated.',
    ['medicnot_find'] =  ' หมอไม่เห็นศพ กรุณากด [~b~X~s~]',
