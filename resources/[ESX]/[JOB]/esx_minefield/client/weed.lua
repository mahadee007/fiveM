	...
	while true do
		...
		if nearbyObject and IsPedOnFoot(playerPed) then
			...
			if IsControlJustReleased(0, Keys['E']) and not isPickingUp then
				...
				ESX.TriggerServerCallback('esx_minefield:canPickUp', function(canPickUp)
				...
				TriggerEvent("mythic_progbar:client:progress", {
					...
					controlDisables = {
						...
						TriggerServerEvent('esx_minefield:pickedUpCannabis')
					else
...
function SpawnWeedPlants()
	while spawnedWeeds < 25 do
		...
		ESX.Game.SpawnLocalObject('prop_rock_4_d', weedCoords, function(obj)
