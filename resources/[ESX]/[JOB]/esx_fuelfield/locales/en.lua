Locales ['en'] = {
  -- weed
  ['weed_pickupprompt'] = 'press ~INPUT_CONTEXT~ to get the ~y~Oil~s~.',
  ['stone_inventoryfull'] = 'you do not have any more inventory space for ~y~Oil~s~.',
  ['weed_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Oil~s~.',
  ['weed_processingstarted'] = 'processing ~g~Oil~s~ into ~g~Marijuana~s~...',
  ['weed_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['weed_processingenough'] = 'you must have ~b~3x~s~ ~g~Oil~s~ in order to process.',
  ['weed_processed'] = 'you\'ve processed ~b~3x~s~ ~g~Oil~s~ to ~b~1x~s~ ~g~Marijuana~s~',
