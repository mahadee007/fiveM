Config.Jobs.miner = {
	...
	Zones = {
		...
		Mine = {
			Pos = {x = 2949.66, y = 2790.87, z = 40.93},
			...
			Item = {
				{
					...
					time = 500,
					remove = 1,
					max = 22, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 67,
					requires = "gold",
			...
			Item = {
				{
					...
					time = 500,
					remove = 1,
					max = 6, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 2500,
					requires = "diamond",
