...
recrueAuthorizedVehicles = {	--แท็กซี่ฝึกหัด
	  { name = 'taxi',		label = 'Taxi-Thailand'		},
    }

    noviceAuthorizedVehicles = {	--แท็กซี่มืออาชีพ
	  { name = 'taxi',		label = 'Taxi-Thailand'		},
    }

    experimenteAuthorizedVehicles = {	--แท็กซี่อาวุโส
	  { name = 'taxi',		label = 'Taxi-Thailand'		},
    }

    uberAuthorizedVehicles = {	 --หัวหน้าแท็กซี่
      { name = 'taxi',		label = 'Taxi-Thailand'		},
    }   

	bossAuthorizedVehicles = {	--ประธานบริษัทแท็กซี่
	  { name = 'taxi',		label = 'Taxi-Thailand'		},
    }
