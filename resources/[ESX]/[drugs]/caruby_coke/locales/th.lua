Locales ['th'] = {
  -- Coke
  ['coke_pickupprompt'] = 'press ~INPUT_CONTEXT~ to pickup the ~g~Coke~s~.',
  ['coke_inventoryfull'] = 'you do not have any more inventory space for ~g~Coke~s~.',
  ['coke_processprompt'] = 'press ~INPUT_CONTEXT~ to start ~g~Process Coke~s~.',
  ['coke_processingstarted'] = 'processing ~g~Coke~s~ into ~g~Coke Pooch~s~...',
  ['coke_processingfull'] = 'processing ~r~canceled~s~ due to full inventory!',
  ['coke_processingenough'] = 'you must have ~b~5x~s~ ~g~Coke~s~ in order to process.',
  ['coke_processed'] = 'you\'ve processed ~b~5x~s~ ~g~Coke~s~ to ~b~1x~s~ ~g~Coke Pooch~s~',
