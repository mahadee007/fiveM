...
AddEventHandler('notifyc', function()
    ...
    if crossing ~= nil then
      ...
      TriggerServerEvent('esx_phone:send', "police", "มีใครบางคนกำลังขายยาที่จุด " .. streetName .. " and " .. crossing, true, {
        x = coords.x,
        y = coords.y,
        z = coords.z
      })
    else
      TriggerServerEvent('esx_phone:send', "police", "มีใครบางคนกำลังขายยาที่จุด " .. streetName, true, {
        x = coords.x,
        y = coords.y,
        z = coords.z
      })
