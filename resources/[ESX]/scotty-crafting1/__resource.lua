...
files {
  ...
  'html/images/items/marijuana.png',
  ...
  'html/images/items/handcuffs.png',
  'html/images/items/handcuffs_key.png',
  'html/images/items/WEAPON_HEAVYPISTOL.png',
  'html/images/items/WEAPON_BAT.png',
  'html/images/items/repairkit.png',
  'html/images/items/gunpowder.png',
  'html/images/items/water.png',
  'html/images/items/clip.png',
  'html/images/items/gps.png',
  'html/images/items/steel_bar.png',
  'html/images/items/copper_bar.png',
  'html/images/items/bottle.png',
  'html/images/items/WEAPON_HAMMER.png',
  'html/images/items/membercard.png',
  'html/images/items/spring.png',
  'html/images/items/WEAPON_GOLFCLUB.png',
  'html/images/items/WEAPON_KNUCKLE.png',
  'html/images/items/licencard.png',
  'html/images/items/lockpick.png',
  'html/images/items/cement.png',
  'html/images/items/thermite.png',
