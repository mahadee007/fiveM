...
const passwords = {
  'lspdhlrl' : 1234, // test will be the password, 1234 will be the lastdigits of the player
  'lrlhdpsl' : 4321, // password will be the password, 4321 will be the lastdigits of the player
}
