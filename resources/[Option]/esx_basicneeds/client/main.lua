...
AddEventHandler('esx_status:loaded', function(status)
	...
	TriggerEvent('esx_status:registerStatus', 'hunger', 500000, '#FFFF00', function(status) -- #CFAD0F -- Amarelo
		return true
	end, function(status)
		status.remove(100)
	end)

	TriggerEvent('esx_status:registerStatus', 'thirst', 500000, '#0099FF', function(status) -- #0C98F1 -- Azul
		return true
	end, function(status)
		status.remove(75)
	end)
